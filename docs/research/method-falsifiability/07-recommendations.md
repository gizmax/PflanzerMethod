...
| P0-4 | **Method Steward FTE redefined** — 0.5-0.7 FTE dedikovaný Senior PM, €100-150k OPEX, Engineering Excellence CoE. NE „EM ve volném čase". | `method-charter.md` § Status + new § „Method Steward operational scope" | 2 h | ADR-0012 |
